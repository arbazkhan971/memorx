...
// schemaV1 contains all CREATE TABLE statements for the devmem database.
const schemaV1 = `
-- ============================================================
-- FEATURES
-- ============================================================
...
// ftsSchemaV1 contains FTS5 virtual table definitions.
// Separated because FTS5 doesn't support IF NOT EXISTS.
const ftsSchemaV1 = `
